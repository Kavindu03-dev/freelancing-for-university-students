    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-2xl shadow-xl p-6">
        ...
        <div className="text-center py-12">
          ...
          <p className="text-gray-500">Your transaction history will appear here once you start earning from completed orders.</p>
        </div>

        {/* TODO: Add transaction list when backend is implemented */}
      </div>

      {/* Quick Actions */}
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="bg-white rounded-2xl shadow-xl p-6 border border-gray-200">
          <h4 className="text-lg font-semibold text-gray-900 mb-4">Withdraw Funds</h4>
          <p className="text-gray-600 mb-4">Withdraw your earnings to your bank account or digital wallet.</p>
          <button className="w-full px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors disabled:opacity-50" disabled>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-6 border border-gray-200">
          ...
          <p className="text-gray-600 mb-4">Manage your payment methods and bank account details.</p>
          <button className="w-full px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors disabled:opacity-50" disabled>
            Manage (Coming Soon)
          </button>
        </div>
      </div>
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <div className="flex flex-wrap justify-center md:justify-start gap-4 mb-6">
              ...
              <div className="flex items-center">
                ...
                { (studentData?.averageRating || studentData?.reviewCount) ? (
                  <span>{((Math.round((studentData?.averageRating || 0) * 10) / 10).toFixed(1))} · {studentData?.reviewCount || 0} {(studentData?.reviewCount === 1) ? 'review' : 'reviews'}</span>
                ) : (
